...
st.title('Lauki Finance: Credit Risk')
...
with row2[0]:
    ...
    st.text(f"{loan_to_income_ratio:.2f}") # Display as text
with row2[1]:
...
if st.button("Calculate Risk"):
    probability, credit_score, rating = predict(age, income, loan_amount, loan_tenure_months,avg_dpd_per_delinquency, delinquent_ratio,
